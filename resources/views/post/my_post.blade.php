    ...
    @foreach($posts as $post)
        <div class="post-preview">
            <h2 class="post-title">
                ...
                @switch($post->status)
                    @case (Config::get('constants.POST_STATUS.PUBLISHED')):
                        <span class="badge badge-pill badge-success">Published</span>
                        @break
                    @case (Config::get('constants.POST_STATUS.SCHEDULING')):
                        <span class="badge badge-pill badge-warning">Scheduling</span>
                        @break
                    @case (Config::get('constants.POST_STATUS.DRAFT')):
